...
import FavoriteIcon from "@mui/icons-material/Favorite"; // ❤️ 찜 아이콘 import
  ...
  return (
    ...
    <AppBar position="fixed" className="navbar">
      <Toolbar className="toolbar">
        ...
        <IconButton component={Link} to="/RecipeList" sx={{ color: "inherit" }}>
          <RestaurantMenuIcon />
        </IconButton>

        <IconButton  component={Link}  to="/RecipeFavorite" sx={{ color: "inherit" }}>
          {/* <IconButton className="button"  component={Link}  to="/RecipeFavorite" sx={{ color: "inherit" }}> */}
          <FavoriteIcon />
          </IconButton>

        <IconButton component={Link} to="/RecipeAbout" sx={{ color: "inherit" }}>
          <InfoIcon />
        </IconButton>
